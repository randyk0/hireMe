...
function saveMemberInfo() {
    var keys = ['first_name', 'last_name', 'email','skill'/*, 'd_o_b'*/];
    var obj = {};
...
function getTableData() {
    ...
    var filteredMembers = members.filter(function (item, index) {
        return item.first_name.toLowerCase().includes(searchKeyword.toLowerCase()) ||
            ...
            item.skill.toLowerCase().includes(searchKeyword.toLowerCase())
    });
...
//    dateOfBirthCell.innerHTML = item.d_o_b;
    ...
    skillCell.innerHTML = '<a class="tag">'+item.skill+'</a>'
    var guid = item.id;

    actionCell.innerHTML ='<button class="btn btn-primary btn-default" onclick="hire(' + guid + ')">Hire</button> ' +
